# <BankCustomer> structure type, which keeps track of customer ID, type of account (‘c’ for checking, ‘s’ for savings, ‘d’ for deposit),
# and account balance. Declared an array of 10 such costumers, and read their data from <acoounts.txt>.
# Found: the average balance for all checking accounts, the average balance for all savings accounts and the average balance for all deposit accounts.
